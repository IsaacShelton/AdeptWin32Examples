...
echo ^[WARNING^] Assuming `adept-nightly` exists and supports version `2.8`
...
call :compile modern\text
call :compile modern\text_change
...
call :compile old_style\text
call :compile old_style\text_change
